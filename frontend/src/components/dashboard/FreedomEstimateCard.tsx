...
interface FreedomEstimateCardProps {
  value: string;
  change: string;
  loading?: boolean;
  empty?: boolean;
...
export const FreedomEstimateCard: React.FC<FreedomEstimateCardProps> = ({
  value,
  change,
  loading = false,
  empty = false,
    ...
    return (
      <div className="card">
        <div className="label" style={{ width: '100%' }}>
          <SkeletonLoader width={140} height={16} className="mb-1" />
        </div>
  ...
  if (error) {
    return (
      <div className="card">
        <div className="label">Financial freedom estimate</div>
